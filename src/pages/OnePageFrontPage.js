    ...
    return (
      <Container className="centerHorizontal">
        <Row className="front-page-full-height" style={{overflow: 'hidden'}}>
          <Col className="m-0 p-0" md={1} sm={false} />
          <Col sm md={3} className="m-0 p-0">
            <div className="centerVertical">
              <div
                className="fill"
                onMouseEnter={() => {
                  this.setState({image_src: image2});
                }}
                onMouseLeave={() => {
                  this.setState({image_src: image1});
                }}>
                ...
                <ScrollAnimation
                  ...
                  animateIn="image-animation-test"
                  delay={500}
                  duration={0.7}>
            ...
            <div className="centerVertical front-page-text ">
              <div className="centerVertical front-page-text-inner">
                <Row className="justify-content-md-center-always">
                  <h1
                    className="dropdown-shadow p-4"
                    style={{width: 'auto', color: '#e6a340'}}>
                    Filip Tangen
                  </h1>
                </Row>
                ...
                <div className="d-sm-block d-md-block d-lg-none d-block text-left p-3 ">
                  <p>
                    3 år student i Bachelor i Informatikk ved NTNU i Trondheim
                  </p>
                  <p>
                    <strong>Alder: </strong>21
                  </p>
                  <p>
                    <strong>Tlf: </strong>91334562
                  </p>
                  ...
                  <Row className="">
                    <Col
                      ...
                      md={1}
                      sm={1}
                      className="m-1 scale-on-hover-big">
                      <a
                        href="https://www.linkedin.com/in/filip-tangen-61614015b/"
                        target="_blank">
                        <img
                          src={linkedinImage}
                    ...
                    <Col
                      ...
                      sm={1}
                      className="m-1 scale-on-hover-big">
                      <a href="https://github.com/filipot" target="_blank">
                        <img
                          src={githubImage}
                          style={{width: '20px', height: '20px'}}
                        />
