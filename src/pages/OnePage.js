...
import redux from '../images/kunnskap/redux.png';
import typescript from '../images/kunnskap/typescript.png';
...
import inmarket from '../images/inmarket2.jpg';
...
class OnePage extends Component {
  ...
  onWheel = event => {
    ...
    this.setState({
      show_scroll_down_mouse: show_scroll_down_mouse,
  ...
  render() {
    return (
      <div style={{overflowX: 'hidden', width: '100vw'}}>
        {this.state.display_name ? <FilipTangen /> : <div />}
        <div className="container-padding-md">
          ...
          <Container id="erfaring" className="p-0">
            ...
            <Row className="mt-5 mb-5 pt-4 pb-4 golden-border-mb">
              <Col lg={3} md={4} className="p-0" style={{zIndex: '40000'}}>
                <div className="fill">
                  <ScrollAnimation
                    className=""
                    animateIn="ani-show-image"
                    delay={400}
                    duration={0.0}>
                    <a className=" " href="https://min-sky.no/" target="_blank">
                      <img
                        className="ani-image-image golden-border scale-on-hover rounded"
                        src={telenor}
                        width={'100%'}
                        alt="me"
                      />
                  ...
                  <ScrollAnimation
                    className="ani-image-div"
                    animateIn="image-animation-right"
                    delay={100}
                    duration={0.4}>
              ...
              <Col lg={5} md={7} className="p-4 text-left black-white">
                <h4>Sommerjobb hos Telenor Software Lab </h4>

                <div className="pl-4 pt-3">
                  <p>
                    Jeg var så heldig å få sommerjobb i 2019 hos Telenor
                    Software Lab.
                  </p>
                  <p>
                    Over 8 uker jobbet jeg sammen med frontend teamet for
                    Telenor sin cloud-tjeneste "Min Sky".
                  </p>
                  <p>
                    Disse verktøyene ble brukt
                    <a
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5  golden-border-mb">
              <Col md={8} className=" m-2 d-block text-left black-white">
                <h4>Denne nettsiden (filiptangen.com) </h4>
                <div className="pl-4 pt-3">
                  <p>
                    Denne nettsiden ble laget på rundt en uke med disse
                    verktøyene
            ...
            <Row className="mt-5 mb-5 pt-4 pb-4 golden-border-mb">
              ...
              <Col lg={5} md={7} className="p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Jeg er med i en startup bedrift som heter InMarket. I
                    bedriften er jobben min å utvikle nettside og app. For mer
                    informasjon om bedriften se{' '}
                    <a href="https://www.inmarket.as" target="_blank">
                      nettsiden
                    </a>
                    .
                  </p>
                  <p>
                    Appen er under utvikling. Den blir bygget med disse
                    verktøyene
                    <a
                      href="https://reactjs.org/"
                      target="_blank"
            ...
            <Row className="mt-5 mb-5 pt-4 pb-5  golden-border-mb">
              <Col md={8} className=" p-4 text-left black-white">
                <h4>
                  ...
                  <a
                    href="https://www.java.com/en/download/faq/whatis_java.xml"
                    target="_blank"
                    className="m-2">
                    <img
                      className="scale-on-hover-big"
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Faget handler om å lære objektorientert programmering og
                    dette blir gjort via java. I forbindelse med jobben har jeg
                    også fått pedagogisk opplæring på{' '}
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              ...
              <Col md={6} className=" pt-5 p-4 text-left black-white">
                <h4>
                  ...
                  <a href="https://ant.design/" target="_blank" className="m-2">
                    <img
                      className="scale-on-hover-big"
                      src={antd}
                      height={'40px'}
                ...
                <div className="pl-4 pt-3">
                  <p>
                    ...
                    <a
                      href="https://www.ntnu.no/studier/emner/TDT4140"
                      target="_blank">
                      Programvareutvikling{' '}
                    </a>
                    laget fem andre og meg en nettside med navnet Momentum.
                    Nettsiden er et møtested for startup-bedrifter og
                    arbeidssøkere.
                  </p>
                  <p>
                    Ta en titt på slideshowet hvis du ønsker et innblikk på
                    hvordan siden så ut som.
                  </p>
                </div>
              </Col>
            </Row>
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              <Col md={4} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Jeg har blitt en entusiastisk tilhenger av Linux. Spesielt
                    er jeg blitt glad i å bruke{' '}
          ...
          <Container className="p-0">
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              <Col md={8} className=" p-4 text-left black-white">
                <h4>
                  Battle Against The Algorithm{' '}
                  <a
                    href="https://chrome.google.com/webstore?hl=no"
                    target="_blank"
                    className="m-2">
                    <img
                      className="scale-on-hover-big "
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Youtube sine algoritmer er eksperter på å fange
                    oppmerksomhet med å vise foreslåtte videoer. Denne chrome
                    extensionen har jeg laget for å fjerne foreslåtte videoer
                    fra youtube.
                  </p>
                  <p>
                    <a
                      href="https://github.com/filipot/BattleAgainstTheAlgorithms"
                      target="_blank">
                      Koden
                    </a>{' '}
                    ligger ute.
                ...
                <div className="justify-content-right w-100">
                  <div className="fill">
                    <ScrollAnimation
                      ...
                      duration={0.0}>
                      <ReactPlayer
                        className="golden-border scale-on-hover rounded "
              ...
              <Col md={8} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    I forbindelse med faget{' '}
                    <a
                      href="https://www.ntnu.no/studier/emner/IT1901#tab=omEmnet"
                      target="_blank">
                      Informatikk prosjektarbeid 1{' '}
                    </a>
                    laget fem andre og meg en nettside som vi kalte for The
                    Scrummer Times. Det var en nettside med mange forskjellige
                    brukertyper som uregistrert bruker, registrert bruker,
                    forfatter, redaktør, daglig leder og administrator.
                    Prosjektet ble gjennomført ved å ha Django som backend og
                    frontend. Gruppen fikk karakter A.
                  </p>
                </div>
              </Col>
            </Row>
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              <Col md={6}>
                <a
                  href="https://online.ntnu.no/wiki/online/info/innsikt-og-interface/interessegrupper/questline/"
                  target="_blank"
                  className="m-0">
                  <img
              ...
              <Col md={6} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Jeg lagde logoen for Questline, som er en interessegruppe
                    innenfor min linjeforening Online. Questline er for de som
                    er interesserte i Dungeons and Dragons.
                  </p>
                </div>
              </Col>
            </Row>
              ...
              <Col md={6} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Under{' '}
                    <a
                      href="http://startntnu.no/grunderjakten/"
                      target="_blank">
                      gr&uuml;nderjakten 2018
                    </a>{' '}
                    var det fire problemstillinger som ble gitt ut av bedrifter.
                    Jeg holdt en pitch på 60 sekunder for en bedrift som drev
                    med VR. Problemstillingen handlet om hvordan FNs
                    bærekraftmål kan bli nådd ved hjelp av VR.
                  </p>
                  <p>
                    Ut fra sirka 20 lag vant gruppen min VR-problemstillingen og
                    premien ble å møte bedriften på pizzakveld og mingle.
                  </p>
                </div>
              </Col>
            </Row>
          ...
          <Container className="p-0">
              ...
              <Col lg={6} md={6} className="p-0" style={{zIndex: '40000'}}>
                <div className="fill">
                  <ScrollAnimation
                    ...
                    <div className="">
                      <a
                        href="https://folk.ntnu.no/sanderbl/webtek/Prosjekt/nettside/index.html"
                        target="_blank"
                        className="m-0">
                        <img
                          className=" golden-border scale-on-hover rounded"
              ...
              <Col md={6} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    ...
                    laget jeg og tre andre en nettside for Gløshaugen
                    bryggeforum for å informere om organisasjonen. I faget var
                    det bare lov å bruke rein HTML, CSS og Javascript. Gruppen
                    fikk karakter A på prosjektet.
                  </p>
                  <p>
                    Se{' '}
                    <a
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              <Col md={5} className=" p-4 text-left black-white">
                <h4>
                  Eksperimenterte med Unity
                  <a href="https://unity.com/" className="m-2" target="_blank">
                    <img
                      className="scale-on-hover-big"
                      src={unity}
                      height={'40px'}
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Da jeg var rundt 15 år ble jeg svært interessert i
                    spillmotoren Unity.
                  </p>
                  <p>
                    Blant annet laget jeg et pikselert spill hvor man kan
                    ødelegge alt som man ser, og grafikken er generert via kode.
                  </p>
                  <p>
                    Også lagde jeg en "voxel-engine" hvor man kan lage terreng
                    som flyter og som man kan ødelegge, dette fikk jeg til ved å
                    bruke{' '}
                    <a
                      href="https://en.wikipedia.org/wiki/Marching_cubes"
                      target="_blank">
                      marching cubes algoritmen
                    </a>
                  </p>
                </div>
              </Col>
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              ...
              <Col md={4} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Da jeg var 14 år gammel ble jeg fasinert over{' '}
                    <a
                      href="https://www.sessions.edu/notes-on-design/whats-the-deal-with-low-poly-art/"
                      target="_blank">
                      lowpoly-kunststil
                    </a>
                    . Jeg eksperimenterte mye rundt i blender og laget disse
                    bildene.
                  </p>
                </div>
              </Col>
            ...
            <Row className="mt-5 mb-5 pt-5 pb-5 golden-border-mb">
              <Col md={5} className=" p-4 text-left black-white">
                ...
                <div className="pl-4 pt-3">
                  <p>
                    Noe av det første jeg begynte med var å prøve å lage spill
                    med bruk av C++, SDL og OpenGL
                  </p>
                  <p>
                    Da laget jeg et spill hvor det var mulig å redigere på
                    nivåene.
                  </p>
