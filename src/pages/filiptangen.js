...
class filiptangen extends Component {
  ...
  render() {
    return (
      <div>
        <OpenEffect
          className="m-1 open-effect-slide-left filiptangen"
          when={0}
          whenclose={0}
          alwaysDisplay>
          <canvas
          ...
          <div
            ...
            <p>3 år student i Bachelor i Informatikk ved NTNU i Trondheim</p>
            <p>21 år gammel</p>
            <p>
              <strong>+47</strong> 91334562
            </p>
            ...
            <Container className="m-0 mt-3 p-0">
              <Row className="justify-content-center m-0 p-0">
                <Col
                  ...
                  md={1}
                  sm={1}
                  className="m-0 p-0 scale-on-hover-big">
                  <a
          ...
          <div>
            <div
              className="p-3 "
              style={{position: 'relative', top: '65vh', width: '200px'}}>
              <p>Min erfaring:</p>
              <Link
                style={{display: 'block', width: '165px', margin: '20px auto'}}
                activeClass="active"
                to="erfaring"
                spy={true}
                smooth={true}
